  ...
  const researchData = [
    {
      ...
      description:
        "Analyzing the correlation between trading patterns and mental wellness indicators",
    },
    {
      ...
      description:
        "Mapping the effectiveness of decentralized mental health support systems",
    },
    {
      ...
      description:
        "Measuring the impact of blockchain-verified counseling sessions",
    },
  ];
    ...
    <section className="py-20 px-4 bg-primary/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {researchData.map((item, index) => (
            ...
            <motion.div
              ...
              className="glass-card p-4 rounded-2xl retro-border"
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-pixel mb-3 text-secondary">
                  {item.title}
                </h3>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1 * 0.2 }}
          className="glass-card mt-20 p-8 rounded-2xl retro-border"
        >
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-pixel mb-4 text-secondary">
