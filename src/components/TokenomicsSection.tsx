    ...
    <section className="py-20 px-4 bg-purple-900/20" id="tokenomics">
      <div className="max-w-7xl mx-auto">
        ...
        {/* <div className="mt-16 glass-card p-8 rounded-2xl">
          <h3 className="text-2xl font-pixel mb-6 text-primary">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <p className="text-3xl font-bold text-accent font-comic mb-2">
                  {tax.value}
                </p>
                <p className="text-sm text-purple-200 font-pixel">
                  {tax.label}
                </p>
              </div>
            ))}
